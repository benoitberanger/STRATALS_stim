...
S.TaskParam.TargetLEFT.Size * S.PTB.Video.Y_total_px                                  , ... % dim == total size (px)
S.TaskParam.TargetLEFT.Size * S.PTB.Video.Y_total_px * S.TaskParam.FixationCross.Width, ... % width == arm size (px)
