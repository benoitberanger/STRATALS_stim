...
% Then, MODEL.Core() is always called to start each task. It is the
% "main" program.
...
if ~isempty(figPtr) % Figure exists so brings it to the focus
    ...
    handles.edit_SubjectID = uicontrol(handles.uipanel_SubjectRun,...
        ...
        'String','',...
        'Callback',@VIEW.Callback.edit_SubjectID);
    ...
    handles.uipanel_EyelinkMode = uibuttongroup(handles.(gui_name),...
        ...
        'BackgroundColor',figureBGcolor,...
        'SelectionChangeFcn',@VIEW.SelectionChangeFcn.uipanel_EyelinkMode);
    ...
    handles.(b_cal.tag) = uicontrol(handles.uipanel_EyelinkMode,...
        ...
        'BackgroundColor',buttonBGcolor,...
        'Tag',b_cal.tag,...
        'Callback',@VIEW.Callback.pushbutton_EyelinkCalibration);
    ...
    handles.(b_cal.tag) = uicontrol(handles.uipanel_EyelinkMode,...
        ...
        'Tag',b_cal.tag,...
        'Callback',@VIEW.Callback.pushbutton_DownloadELfiles);
    ...
    VIEW.SelectionChangeFcn.uipanel_EyelinkMode(handles.uipanel_EyelinkMode, eventdata)
