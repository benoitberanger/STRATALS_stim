...
if ~isempty(figPtr) % Figure exists so brings it to the focus
    ...
    msg = 'Calibration values (Left / Right) will go here ===>';
    t_Calib.x   = b_Calib.x;
    t_Calib.w   = b_Calib.w;
    t_Calib.y   = 0.05;
    t_Calib.h   = 0.40;
    t_Calib.tag = 'text_Calib';
    handles.(t_Calib.tag) = uicontrol(handles.uipanel_Task,...
        'Style'          , 'text'                         ,...
        'Units'          , 'Normalized'                   ,...
        'Position'       , [t_Calib.x t_Calib.y t_Calib.w t_Calib.h],...
        'String'         , msg                            ,...
        'Tag'            , t_Calib.tag                    );
    
    e_CalLeft.x   = b_Nut.x;
    e_CalLeft.w   = b_Nut.w/2;
    e_CalLeft.y   = t_Calib.y;
    e_CalLeft.h   = t_Calib.h;
    e_CalLeft.tag = 'edit_Calib_Left';
    handles.(e_CalLeft.tag) = uicontrol(handles.uipanel_Task,...
        'Style'          , 'edit'                           ,...
        'Units'          , 'Normalized'                     ,...
        'Position'       , [e_CalLeft.x e_CalLeft.y e_CalLeft.w e_CalLeft.h],...
        'String'         , ''                               ,...
        'BackgroundColor', editBGcolor                      ,...
        'Tag'            , e_CalLeft.tag                    ,...
        'TooltipString'  , 'Left calibration value [0-1]'  );
    
    e_CalRight.x   = e_CalLeft.x + e_CalLeft.w;
    e_CalRight.w   = b_Nut.w/2;
    e_CalRight.y   = e_CalLeft.y;
    e_CalRight.h   = e_CalLeft.h;
    e_CalRight.tag = 'edit_Calib_Right';
    handles.(e_CalRight.tag) = uicontrol(handles.uipanel_Task,...
        'Style'          , 'edit'                           ,...
        'Units'          , 'Normalized'                     ,...
        'Position'       , [e_CalRight.x e_CalRight.y e_CalRight.w e_CalRight.h],...
        'String'         , ''                               ,...
        'BackgroundColor', editBGcolor                      ,...
        'Tag'            , e_CalRight.tag                    ,...
        'TooltipString'  , 'Right calibration value [0-1]'  );
